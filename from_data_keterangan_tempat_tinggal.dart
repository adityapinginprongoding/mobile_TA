...
class FromDataKeteranganTempatTinggal extends StatelessWidget {
  const FromDataKeteranganTempatTinggal({super.key});
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 12),
                        CommonTextField(title: 'Nomor Telp/Hp'),
                        const SizedBox(height: 12),
                        CommonTextField(title: 'Tinggal Dengan Orang Tua/ Saudra/ Di Asrama/ Kost'),
                        const SizedBox(height: 12),
